...
const EMPLOYEES = require("../config/employees.js");
...
async function generateWeeklyAttendancePDF({ when = DateTime.now().setZone(ZONE) } = {}) {
...
module.exports = { generateWeeklyAttendancePDF };
